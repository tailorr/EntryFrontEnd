...
var APP_ID = 'OKiGrX9NucMXY4MCyHVOGKYo-gzGzoHsz';
var APP_KEY = 'ECq0UfGst8lhHTeS6xSK7zKN';
    ...
    methods: {
        ...
        getCurrentUser: function getCurrentUser() {
            ...
            if (current) {
                ...
                return { id: id, createAt: createAt, username: username };
            } else {
                return null;
            }
        },
        saveTodos: function saveTodos() {
            ...
            var Todo = function (_AV$Object) {
                _inherits(Todo, _AV$Object);
                ...
                return Todo;
            }(_leancloudStorage2.default.Object);

            _leancloudStorage2.default.Object.register(Todo);
        ...
        updateTodos: function updateTodos() {
            var dataString = JSON.stringify(this.todoList);
            var avTodos = _leancloudStorage2.default.Object.createWithoutData('Todo', this.todoList.id);
        ...
        fetchTodos: function fetchTodos() {
            ...
            if (this.currentUser) {
                ...
                query.find().then(function (todos) {
                    ...
                    _this5.todoList = JSON.parse(avAllTodos.attributes.content);
                    _this5.todoList.id = id;
                }, function (error) {
                    console.log(error);
                });
            }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(79), __webpack_require__(3)))
