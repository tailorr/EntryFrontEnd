...
var Toast = function () {
    ...
    var init = function init(message, time) {
...
var Waterfall = function () {
    var _Waterfall = function () {
        function _Waterfall($ct) {
            _classCallCheck(this, _Waterfall);
        ...
        _createClass(_Waterfall, [{
            key: "_render",
            value: function _render() {
                var columnWidth = this.$item.outerWidth(true),
                ...
                this.$item.each(function (index, element) {
                    var minIndex = 0,
                        minHeight = columnHeight[0];

                    for (var _i = 0; _i < columnHeight.length; _i++) {
                        if (columnHeight[_i] < minHeight) {
                            minIndex = _i;
                            minHeight = columnHeight[_i];
                        }
                    }
                    $(element).css({
